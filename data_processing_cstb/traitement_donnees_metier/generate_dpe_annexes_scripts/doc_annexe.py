...
gorenove_vars = {
    ...
    "tr002_type_batiment_id": "type de bâtiment : 1 MI , 2 : APPT , 3 : IMMEUBLE, ",
    ...
    # ENV
    "mur_u_ext": "U du mur en W/m²/K",
    "pb_u": "U du plancher bas en W/m²/k",
    "ph_u": "U du plancher haut en W/m²/K",
    "baie_u": "U de la baie (Ujn ou Uw)  en W/m²/K",
    "baie_fs": "Facteur solaire de la baie",
    "mur_mat_ext": "matériaux le plus fréquent de la structure des murs extérieurs(sans l'isolation)",
    "mur_ep_mat_ext": "epaisseur de la structure des murs ",
    "pb_mat": "matériaux ou principe constructif du plancher bas",
    "ph_mat": "matériaux ou principe constructif du plancher haut",
    "baie_mat": "matériaux de l'encadrement de la baie",
    "baie_type_vitrage": "type de vitrage le plus fréquent des baies",
    "baie_remplissage": "remplissage argon ou air la plus fréquentement trouvé pour les vitrages",
    ...
    "mur_pos_isol_ext": "position de l'isolation des murs extérieurs(ITI/ITE/ITR/non isole/isole)",
    "pb_pos_isol": "position de l'isolation des plancher bas(ITI/ITE/ITR/non isole/isole)",
    "ph_pos_isol": "position de l'isolation des plancher haut (ITI/ITE/ITR/non isole/isole)",
    "pb_type_adjacence": "type d'adjacence la plus fréquente des planchers bas",
    "ph_type_adjacence": "type d'adjacence la plus fréquente des planchers haut",
    ...
    "periode_construction": "période de construction du bâtiment référencé par les DPE",
    "inertie":  "inertie la plus fréquente référencé par les DPE",
