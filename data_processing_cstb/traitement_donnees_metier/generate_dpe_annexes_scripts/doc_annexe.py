...
td001_annexe_enveloppe_agg_desc = {
    ...
    'mat_pb_deper_top': "matériau principal des planchers basne donnant pas sur un logement mitoyen(avec la plus grande surface associée ) (matériau au sens de la TV006).",
    'mat_ph_deper_top': "matériau principal des murs donnant sur l'extérieur ou un local non chauffé (avec la plus grande surface ) (matériau au sens de la TV008).",
...
td001_sys_ch_agg_desc = {
    ...
    'sys_ch_princ_conso_ch': 'consommation de chauffage du système de chauffage principal',
    ...
    'sys_ch_princ_type_energie_ch': "type d'energie de chauffage du système de chauffage principal  (voir enumérateur type_energie_ch)",
    'sys_ch_princ_type_installation_ch': "type d'installation de chauffage pour le système de chauffage principal (collectif ou individuel)",
...
td001_td007_ph_agg_annexe_desc = {
    ...
    "meth_calc_u_ph_top": "methode de calcul du coefficient de déperdition du mur (U) principale.",
...
td001_td007_pb_agg_annexe_desc = {
    ...
    "meth_calc_u_pb_top": "methode de calcul du coefficient de déperdition du mur (U) principale.",
...
td012_annexe_desc = {
    ...
    'type_energie_ch': "type d'energie de chauffage (voir enum type_energie_ch) issu de tv045_energie principalement"}
