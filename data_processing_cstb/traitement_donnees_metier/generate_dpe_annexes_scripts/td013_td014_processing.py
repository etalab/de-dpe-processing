...
td014_gen_to_installation_infer_dict = {'ecs thermodynamique electrique(pompe a chaleur ou ballon)': 'indetermine',
                                        ...
                                        'chaudiere gpl/butane/propane condensation': 'individuel',
