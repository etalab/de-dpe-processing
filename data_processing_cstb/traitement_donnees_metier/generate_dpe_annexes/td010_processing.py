...
def agg_td010_td001(td010):
    ...
    type_isol_ph = agg_pond_top_freq(td010_ph, 'tv013_plancher_bas', 'longueur',
                                          'td001_dpe_id').to_frame('pos_isol_ph')

    td010_pt_agg = pd.concat([type_isol_mur, type_isol_pb, type_isol_ph, long], axis=1)
